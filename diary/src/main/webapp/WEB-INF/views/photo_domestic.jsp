...
<head>
	...
	<script src="./resources/js/photo-domestic.js"></script>
	...
	<div class="photo-body">
		...
		<div class="photo-content">
			<div class="photo-search">
				...
				<input class="search" id="search" type="search" placeholder="숨은 명소를 알고싶은 지역을 검색하세요 (ex. 시,도/지역이름)"/>
			...
			<ul id="pagination-domestic" class="pagination-sm"></ul>
