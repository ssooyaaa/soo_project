...
<head>
	...
	<script src="${pageContext.request.contextPath}/resources/js/photo_report.js"></script>
...
<body>
		...
		<table class="table" style="table-layout:fixed; width:85%;margin-left:90px;">
			  <thead style="width:85%;margin-left:90px;">
			    <tr style="font-size:20px;text-align:center">
			      <th scope="col" class="ph-table-idx">번호</th>
			      <th scope="col" class="ph-user-idx">사용자번호</th>
			      <th scope="col" class="ph-report-desc">보고내용</th>
			      <th scope="col" class="ph-img">이미지</th>
			      <th scope="col" class="ph-contents">photos-내용</th>
	...
	<ul id="pagination-photo-report" class="pagination-sm"></ul>
